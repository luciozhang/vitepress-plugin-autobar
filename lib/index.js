(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash/startCase'), require('lodash/sortBy'), require('path'), require('glob')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lodash/startCase', 'lodash/sortBy', 'path', 'glob'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uodule = {}, global.startCase, global.sortBy, global.path, global.glob));
})(this, (function (exports, startCase, sortBy, path, glob) { 'use strict';
    ...
    var getChildren = function (parentPath) {
        ...
        return sortBy(files, ['path']).map(function (file) { return file.path; });
    };
